...
--schema-only --clean -h host.docker.internal -U slinkylinky --no-role-passwords > 'C:/Users/Ramsay Domloge/Downloads/full-db-schema-backup.sql'

docker run -ti --rm --env PGPASSWORD=sl --entrypoint pg_dump -ti postgres \
--schema-only --no-owner \
-h host.docker.internal -U slinkylinky > 'C:/Users/Ramsay Domloge/Downloads/slinkylinky-schema-backup.sql'
...
-h host.docker.internal -U slinkylinky > 'C:/Users/Ramsay Domloge/Downloads/core-tables-backup.sql'
