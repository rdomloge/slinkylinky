    ...
    return (
        <li className="relative mb-6 sm:mb-0 mt-2 ">
            ...
            <div className="mt-3 sm:pe-8">
                {showError ? <img src={WarningIcon} width={20} height={20} alt="Warning icon" className={"inline-block mx-2 mb-1"}/> : null }
                ...
                {linkText && linkUrl ?
                    <p className="text-gray-500 dark:text-gray-400 truncate">{description} <Link to={linkUrl} rel='nofollow'>{linkText}</Link></p>
                :
