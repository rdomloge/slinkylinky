    ...
    return (
        <Modal title={"AI content generator"} width={"w-4/5"} dismissHandler={dismissHandler}>
            ...
            <textarea id="content" rows="16" placeholder="Generated content (feel free to edit)" value={content} onChange={(e)=>setContent(e.target.value)}
                className="block p-2.5 w-full text-sm font-mono text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </textarea>
