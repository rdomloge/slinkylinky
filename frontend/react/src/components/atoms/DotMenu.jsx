...
export default function DotMenu({items, classNames}) {
    ...
    return (
        <div className={`relative ${classNames ?? ''}`}>
            ...
            <div id="dropdownDots" className={`z-50 absolute right-0 bg-white divide-y divide-gray-100 rounded-lg shadow-md border w-44 dark:bg-gray-700 dark:divide-gray-600 ${menuOpen?"":"hidden"}`}>
