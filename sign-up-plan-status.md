...
- Current stage: Stage 03 — email verification and verified-only access
- Next stage: Stage 04 — public registration UI
- Current step in active stage: 8 of 8 (complete)
- Last updated: 2026-04-25 (Stage 03 execution complete)
...
| 04 | `sign-up-planv2-04.md` | public registration UI | PENDING | Depends on Stages 02–03. |
| 05 | `sign-up-planv2-05.md` | audit coverage and access cleanup | PENDING | Best after Stages 02 and 03. |
| 06 | `sign-up-planv2-06.md` | global-admin organisations overview | PENDING | Best after foundational backend work exists. |
| 07 | `sign-up-planv2-07.md` | integration test and coverage wiring | PENDING | Per-component unit tests now ship inside Stages 02–06; this stage covers only `RegistrationFlowIT` and JaCoCo wiring. |
| 08 | `sign-up-planv2-08.md` | CI/CD and deployment wiring | PENDING | Final delivery-hardening stage. |
