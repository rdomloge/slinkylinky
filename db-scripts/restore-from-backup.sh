...
-f backup/2024-03-27_1000-backup.sql -h host.docker.internal -U slinkylinky postgres
...
-f backup/v3.9-sql-changes.sql -h host.docker.internal -U slinkylinky slinkylinky