...
--name sl-linkservice \
--rm \
rdomloge/slinky-linky-linkservice-crac:latest \
java -XX:CRaCCheckpointTo=crac-files -Djdk.crac.collect-fd-stacktraces=true -jar linkservice.jar